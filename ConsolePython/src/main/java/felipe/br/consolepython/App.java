...
//        
        String pythonPath = "";
        String pythonCommand = "python -u";
        String pythonPrgramFolder = "/home/proto/Projetos/python/";
        String pythonPrgramFilename = "loop.py";
        String params = "felipe";

        String prgramFile = (pythonPrgramFolder + "/" + pythonPrgramFilename).replace("//", "/");
//        
